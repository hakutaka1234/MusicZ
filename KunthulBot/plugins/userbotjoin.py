...
from KunthulBot import *
from KunthulBot.status import *



@KunthulBot.on(events.NewMessage(pattern="&join"))
@KunthulBot.on(events.NewMessage(pattern="&userbotjoin"))
@is_admin
async def _(e, perm):
    chat_id = e.chat_id
...
@KunthulBot.on(events.NewMessage(pattern="&pjoin"))
@is_admin        
async def _(e, perm):
    chat_id = e.chat_id
